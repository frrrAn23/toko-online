            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="footer">
                        ...
                        <div class="footer-logo">
                            <a class="logo" href="#">
                                <img src="frontend/image/icon_univ_bsi.png" alt="">
                            </a>
                        </div>
                        <!-- /footer logo -->

                        <p>Toko online kami menghadirkan produk berkualitas dengan proses belanja yang mudah dan aman! 🛒
                            Temukan berbagai pilihan terbaik sesuai kebutuhan Anda.
                            Belanja sekarang dan nikmati kemudahan bertransaksi!
                        </p>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="footer">
                        ...
                        <p>Jangan sampai ketinggalan! Masukkan email Anda sekarang dan jadilah yang pertama mendapatkan penawaran spesial💌.</p>
                        <form>
